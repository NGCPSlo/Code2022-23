...
def callback(x):
   ...
   HSV_LOW[1] = cv.getTrackbarPos('hsv_low_s','Track')
   HSV_LOW[2] = cv.getTrackbarPos('hsv_low_v','Track')
...
cv.createTrackbar('hsv_low_s','Track', 100, 255, callback)
cv.createTrackbar('hsv_low_v','Track', 50, 255, callback)
cv.createTrackbar('hsv_high_h','Track', 180, 180, callback)
cv.createTrackbar('hsv_high_s','Track', 255, 255, callback)
cv.createTrackbar('hsv_high_v','Track', 255, 255, callback)
